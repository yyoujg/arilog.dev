...
export const RESUME: Resume = {
  ...
  experience: [
    ...
    {
      company: COMPANY,
      role: "운영 어드민 이관 · 시설·다이닝 도메인 담당 (3인 팀)",
      period: "2025.06 ~ 2025.07",
      description: [
        "별도 시스템으로 운영되던 예약 백오피스를 사내 Portal 시스템으로 이관하는 프로젝트에 참여했습니다.",
        "화면을 그대로 옮기면 두 시스템의 코드 컨벤션이 섞이므로, 이관 대상 소스를 먼저 분석해 컨벤션을 파악했습니다.",
        "시설 관리(브랜드별 목록·등록/수정 라우팅·필터링)와 다이닝 관리(F&B·판매·타임테이블·예약) 메뉴를 그 컨벤션에 맞춰 재구현",
