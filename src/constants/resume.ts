...
export const RESUME: Resume = {
  ...
  experience: [
    ...
    },
    {
      ...
      period: "2024.04 ~ 재직중",
      description: [
        "파르나스 계열과는 별도 레포·별도 배포 파이프라인을 쓰는 B2C 예약 사이트에서 검색·날짜 선택 영역을 담당했습니다.",
        "\"검색 캘린더에서 체크아웃 날짜가 선택되지 않는다\"로 접수된 건을 따라가다, 같은 코드에서 막혀야 하는데 안 막히는 반대 방향의 결함을 찾았습니다. 공용 날짜 유틸이 \"yyyy-MM-dd\" 문자열을 UTC 자정으로 해석해 캘린더 쪽 로컬 자정 기준과 9시간 어긋나 있었고, 그래서 품절인 밤이 낀 예약이 그대로 통과하고 있었습니다.",
