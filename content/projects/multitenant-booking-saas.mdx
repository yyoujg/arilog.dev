...
- [CLS 0.440의 94%는 스켈레톤 하나였다 — 측정 기준선부터 세운 레이아웃 시프트 개선](/blog/posts/cls-skeleton-box-mismatch)
- [누구나 인증 헤더를 붙여 보낼 수 있었다 — BFF 프록시에서 헤더를 지우고 다시 심은 이야기](/blog/posts/bff-proxy-forged-auth-headers)
- [URL에 예약번호를 실어야 했다 — 개인정보를 봉인 토큰으로 감춘 이야기](/blog/posts/sealed-token-aes-gcm)
- [결제는 됐는데 예약이 안 됐다 — '과금-미예약' 불일치를 구조로 막은 이야기](/blog/posts/payment-booking-consistency)
- [토큰 시스템을 만들어놓고 아무도 안 쓰고 있었다 — Tailwind 임의값을 걷어낸 이야기](/blog/posts/tailwind-arbitrary-values-to-tokens)
